...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(CGRosa.isTouching(ciclistaPrincipal)){
    ...
    textSize(20);
    fill(255);
    text("Aperte a tecla direcional para cima para reiniciar o jogo!", 385,250);
...
function recomecar(){
  ...
  ciclistaPrincipal.addAnimatiom("SahilRunning",img1CiclistaPrincipal);
  
  CGRosa.detroyEach();
  CGAmarelo.detroyEach();
  CGVermelho.detroyEach();
